...
function __promptline {
  ...
  local a_bg="${wrap}48;5;151${end_wrap}"
  local a_sep_fg="${wrap}38;5;151${end_wrap}"
  local b_fg="${wrap}38;5;239${end_wrap}"
  local b_bg="${wrap}48;5;237${end_wrap}"
  local b_sep_fg="${wrap}38;5;237${end_wrap}"
  local c_fg="${wrap}38;5;151${end_wrap}"
  ...
  local y_fg="${wrap}38;5;239${end_wrap}"
